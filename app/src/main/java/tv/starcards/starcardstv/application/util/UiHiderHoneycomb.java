...
/**
 * An API 11+ implementation of {@link UiHider}. Uses APIs available in
 * Honeycomb and later (specifically {@link View#setSystemUiVisibility(int)}) to
 * show and hide the system UI.
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB)
public class UiHiderHoneycomb extends UiHiderBase {
    /**
     ...
     */
    protected UiHiderHoneycomb(Activity activity, View anchorView, int flags) {
