 ...
 * {@link #getInstance} will return a {@link UiHiderHoneycomb} instance,
 * while on older devices {@link #getInstance} will return a
 * {@link UiHiderBase} instance.
 * <p/>
...
public abstract class UiHider {
    ...
    /**
     * Creates and returns an instance of {@link UiHider} that is
     * appropriate for this device. The object will be either a
     * {@link UiHiderBase} or {@link UiHiderHoneycomb} depending on
     * the device.
     *
     ...
     */
    public static UiHider getInstance(Activity activity, View anchorView, int flags) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            return new UiHiderHoneycomb(activity, anchorView, flags);
        } else {
            return new UiHiderBase(activity, anchorView, flags);
        }
    }

    protected UiHider(Activity activity, View anchorView, int flags) {
        mActivity = activity;
